...
const CategoryBarGraph = () => {
  const allCategory = ["Productivity", "Communcation", "SNS", "Entertainment", "Total"];
  const allColors = {"Productivity":["#883DA2", "#CCAFDA"], "Communcation":["#7BAB63", "#C7DBC1"], "SNS":["#FFBC47", "#FBE2B5"], "Entertainment":["#E4567C", "F1B9CB"], "Total":["#3598DB", "ABD3F1"]};
